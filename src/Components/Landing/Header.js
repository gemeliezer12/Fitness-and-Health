    ...
    return (
        <>
            <div className="color-inherit dark" style={{
                background: "linear-gradient(0deg, var(--fuchsia) 0%, var(--indigo) 100%)",
                color: "white"
            }}>
